...
C
      ...
      DO INW = 1, NNW
         ...
         DO IED = 1, 2
            ...
            AGP1  = AGP + 1 - AED
            AGP2  = AGP + 2 - AED
            X_XIXI = CRD (1, AGP1) * W (1) + CRD (1, AGP2) * W (2)
     &             + CRD (3, AGP1) * W (3) + CRD (3, AGP2) * W (4)
            Z_XIXI = CRD (2, AGP1) * W (1) + CRD (2, AGP2) * W (2)
     &             + CRD (4, AGP1) * W (3) + CRD (4, AGP2) * W (4)
