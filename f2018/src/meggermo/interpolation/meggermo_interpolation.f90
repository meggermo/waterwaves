...
contains
   ...
   real(kind=rk) function eval(x, k1, k2, f)
      real(kind=rk), intent(in) :: x, k1, k2, f(4)
      ! Local variables
      real(kind=rk) :: w(4)
      ! Body
   ...
   pure real(kind=rk) function n_1(x, k1, k2)
      real(kind=rk), intent(in) :: x
      real(kind=rk), intent(in) :: k1, k2
      ! Body
      n_1 = -(1.0 - k1)**2/(1 + k1)*(x**3 - x**2 - x + 1.0)/16.0
   end function

   pure real(kind=rk) function dn_1(x, k1, k2)
      real(kind=rk), intent(in) :: x
      real(kind=rk), intent(in) :: k1, k2
      ! Body
   ...
   pure real(kind=rk) function n_2(x, k1, k2)
      real(kind=rk), intent(in) :: x
      real(kind=rk), intent(in) :: k1, k2
      ! local variables
      real(kind=rk) :: a(4)
   ...
   pure real(kind=rk) function dn_2(x, k1, k2)
      real(kind=rk), intent(in) :: x
      real(kind=rk), intent(in) :: k1, k2
      ! local variables
      real(kind=rk) :: a(3)
   ...
   pure real(kind=rk) function n_3(x, k1, k2)
      real(kind=rk), intent(in) :: x
      real(kind=rk), intent(in) :: k1, k2
      ! local variables
      real(kind=rk) :: a3, a2, a1, a0
      ! Body
      a3 = 3.0 - k1 + k2 + k1*k2
   ...
   pure real(kind=rk) function dn_3(x, k1, k2)
      real(kind=rk), intent(in) :: x
      real(kind=rk), intent(in) :: k1, k2
      ! local variables
      real(kind=rk) :: a3, a2, a1
      ! Body
      a3 = 3.0 - k1 + k2 + k1*k2
      a2 = 1.0 + k1 + 3.0*k2 - k1*k2
      a1 = -11.0 + k1 + 7.0*k2 - k1*k2
   ...
   pure real(kind=rk) function n_4(x, k1, k2)
      real(kind=rk), intent(in) :: x
      real(kind=rk), intent(in) :: k1, k2
      ! Body
   ...
   pure real(kind=rk) function dn_4(x, k1, k2)
      real(kind=rk), intent(in) :: x
      real(kind=rk), intent(in) :: k1, k2
      ! Body
